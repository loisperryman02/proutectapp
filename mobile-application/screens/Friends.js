...
export default function Friends({ navigation, route }) {
    ...
    useEffect(() => {
        const fetchRequests = async () => {
            ...
            const response = await axios.get(`http://172.25.11.245:3000/friend/requests/${username}`);
    ...
    const handleAccept = (item) => {
        const url = "http://172.25.11.245:3000/acceptUser";
        const accept_user = {
    ...
    const handleReject = (item) => {
        const url = "http://172.25.11.245:3000/rejectUser";
        const accept_user = {
    ...
    const sendFriendRequest = () => {
        const url = "http://172.25.11.245:3000/friend";
